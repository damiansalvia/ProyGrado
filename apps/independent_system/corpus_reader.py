...
def Test():
    ...
    obtained = correct(u"1º Acto: Yo haciendo tareäs.\u0083 2º Acto: Yo estudiaaando. 3º Acto: Yo rècogiendo... ¡mi cuarto!.¿CÓMO SE LLAMA LA OBRA? `No tengo vida´ 😡")
